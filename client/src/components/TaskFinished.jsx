...
const TaskFinished = ({handleSignOut, status}) => {
  ...
  return (
    <div className={styles.container} data-test="continue">
      <h3 className={styles.titleText}>You have finished all available tasks</h3>

      <h5 className={styles.titleText}>Press Continue to choose another treebank or press Signout to exit</h5>
